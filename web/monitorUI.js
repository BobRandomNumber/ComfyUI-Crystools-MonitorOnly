...
export class MonitorUI extends ProgressBarUIBase {
    ...
    constructor(rootElement, monitorCPUElement, monitorRAMElement, monitorHDDElement, monitorGPUSettings, monitorVRAMSettings, monitorTemperatureSettings, currentRate) {
        ...
        this.monitorRAMElement = monitorRAMElement;
        this.monitorHDDElement = monitorHDDElement;
        this.monitorGPUSettings = monitorGPUSettings;
    ...
    createDOMGPUMonitor = (monitorSettings) => {
    ...
    updateMonitor = (monitorSettings, percent, used, total) => {
    ...
    updatedAnimationDuration = (monitorSettings, value) => {
    ...
    showMonitor = (monitorSettings, value) => {
        if (monitorSettings.htmlMonitorRef) {
